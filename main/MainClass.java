...
class MainClass	extends 	JFrame
{
	...
	public void createPage1()
	{
		...
		final JLabel lb4=new JLabel("STATUS : No File Selected!!");
		...
		chooseFile.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent ae)
            {
				...
				if (returnVal == JFileChooser.APPROVE_OPTION) 
				{
					...
					lb4.setText("STATUS : File Selected!!");
				}
				else
				{
				}
        ...
        chooseFolder.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent ae)
            {
				...
				if (chooser.showOpenDialog(MainClass.this) == JFileChooser.APPROVE_OPTION) 
				{
					folderAdd.setText("");
	...
	public void createPage3()
	{
		...
		JLabel lb=new JLabel("<html><b>ABOUT : </b><br/><br/>This is a simple java application to split large files into small parts. If anyone needs to mail files or wants to upload files where there is limitation on maximum file size then he can split the large file into small parts and then afterwards he can join these parts using the same application.</html>");
		lb.setBounds(30,30,500,100);
		JLabel dis=new JLabel("<html><b><u>Copyright\u00a9 2013 Rakshendra, Himanshu, Shubham. All Rights Reserved </u></b><br/><br/> You may use, distribute and should not request the source code of this program.<br/>For any suggestions or queries : <u><i><a href=\"www.rakshendra.in\">http://www.rakshendra.in</a></i></u></html>");
		dis.setBounds(30,200,500,100);
		panel3.add(lb);
		panel3.add(dis);
	}
